...
const fields: { key: keyof FormValues; label: string; suffix?: string }[] = [
  ...
  { key: "laborDay", label: "Mano de obra (día)", suffix: "COP" },
...
const SECTIONS: SectionSpec[] = [
  ...
  },
  {
    ...
    subtitle:
      "Precios COP por día o por m²: sirven como base para cotizar, no cubren equipo intermitente por sí solos.",
    icon: ClipboardList,
    iconWrap:
    ...
    keys: ["laborDay", "laborM2Concrete", "laborM2BlockWall"],
  },
  {
    id: "finishes-wall",
